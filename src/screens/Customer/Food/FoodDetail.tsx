...
const FoodDetailScreen = () => {
  ...
  // --- GỌI API ---
  const { data, loading, error, refetch } = useQuery<FoodDetailResponse>(GET_FOOD_DETAIL_QUERY, {
              ...
              {['10"', '14"', '16"'].map((size, index) => (
                ...
                >
                  <Text style={[
                      ...
                      isSelected === size && { color: '#fff', fontWeight: 'bold' }
                  ]}>
                    {size}
                  </Text>
                </TouchableOpacity>
                      ...
                      <View key={review.id} style={styles.reviewItem}>
                          ...
                          <View style={{flex: 1}}>
                              <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                  <Text style={styles.reviewerName}>{review.user?.name || "Người dùng ẩn danh"}</Text>
...
const styles = StyleSheet.create({
  ...
  backButton: {
    ...
    justifyContent: 'center', alignItems: 'center', backgroundColor: '#ECF0F4',
  },
  headerTitle: {
    fontSize: 20, fontWeight: '600', color: colors.black,
  },
  imageContainer: {
    marginBottom: 10, position: 'relative', paddingHorizontal: 25,
  },
  imagePlaceholder: {
    width: '100%', height: 200, backgroundColor: colors.gray, borderRadius: 20, marginBottom: 20,
  },
  favoriteButton: {
    backgroundColor: '#ffffffcc', borderRadius: 50, width: 45, height: 45,
    justifyContent: 'center', alignItems: 'center', position: 'absolute', bottom: 30, right: 35, zIndex: 10,
  },
  restaurantLabel: {
    position: 'absolute', top: 15, left: 35, flexDirection: 'row', alignItems: 'center',
    backgroundColor: 'white', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 6,
  ...
  foodTitle: {
    fontSize: 24, fontWeight: 'bold', color: colors.black, marginBottom: 10,
  },
  foodDescription: {
    fontSize: 14, color: '#858992', marginBottom: 20, lineHeight: 22,
  },
  restaurantMeta: {
  ...
  sectionTitle: {
    fontSize: 14, fontWeight: 'bold', color: colors.black, marginBottom: 15, textTransform: 'uppercase',
  },
  sizeOptionsRow: {
    flexDirection: 'row', gap: 15,
  },
  sizeOption: {
    backgroundColor: '#F0F5FA', borderRadius: 50, paddingVertical: 10, paddingHorizontal: 20,
  },
  sizeOptionText: {
  ...
  reviewItem: {
      flexDirection: 'row', marginBottom: 15, backgroundColor: '#F6F6F6', padding: 10, borderRadius: 12
  },
  reviewerAvatar: {
      width: 40, height: 40, borderRadius: 20, marginRight: 10
  },
  reviewerName: {
      fontWeight: 'bold', fontSize: 14, color: '#181C2E'
  },
  reviewContent: {
      fontSize: 13, color: '#5B5B5E', marginTop: 4, marginBottom: 4
  },
  reviewDate: {
      fontSize: 10, color: '#A0A5BA'
  },
  // Bottom Fixed
  priceContainer: {
    position: 'absolute', bottom: 0, left: 0, right: 0,
    backgroundColor: '#F0F5FA', borderTopLeftRadius: 30, borderTopRightRadius: 30,
  ...
  quantityContainer: {
    backgroundColor: '#121223', borderRadius: 30, flexDirection: 'row', alignItems: 'center', padding: 5,
  },
  quantityButton: {
    width: 35, height: 35, alignItems: 'center', justifyContent: 'center',
    borderRadius: 17.5, backgroundColor: 'rgba(255,255,255,0.2)',
  },
  quantityButtonText: {
    fontSize: 20, fontWeight: 'bold', color: '#fff', marginTop: -2,
  },
  quantityText: {
    fontSize: 18, fontWeight: 'bold', color: '#fff', marginHorizontal: 15,
  },
  addToCartButton: {
    backgroundColor: colors.primary, borderRadius: 20, paddingVertical: 18, alignItems: 'center',
  },
  addToCartText: {
    fontSize: 16, fontWeight: 'bold', color: colors.white, textTransform: 'uppercase',
  },
});
